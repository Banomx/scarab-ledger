/* ================================================================
   ...
   Run it against a live league:
     node scripts/audit-drops.mjs                 # current league
     node scripts/audit-drops.mjs "Allflame"      # a specific one
     node scripts/audit-drops.mjs --json          # machine-readable
...
import { BOSSES } from "../src/bossData.js";
import { makeResolver, computeBoss, variantHint, isUnidentified, dropKey } from "../src/bossProfit.js";
import { watchLeagues, matchWatchLeague, fetchWatchLeague, watchJson } from "./poewatch.mjs";
...
if (renamed.length) {
  ...
  console.log(`Where it is plainly the same item, fix the name in src/bossData.js.\n`);
